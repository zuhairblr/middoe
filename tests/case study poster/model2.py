...
def solve_model(t, y0, tii, tvi, theta):
    ...
    def M(t, y, tii, tvi, theta, te):
        ...
        theta2 = 0.15526347528322604 # Michaelis constant
        theta3 = 0.7046749568966176   # Yield coefficient
        theta4 = theta[1]  # Biomass loss rate due to non-modeled factors
        theta5 = 5.21836289470247  # Substrate inhibition constant
